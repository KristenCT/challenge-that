...
export default function Article() {
  return (
    ...
    >
      ...
      <p>In our experience auditing venue CRM databases, between 40&ndash;70% of member records are missing either a valid email address or a valid mobile number. <strong>These aren&rsquo;t lapsed members - many are active visitors who enrolled at the bar and gave minimal details.</strong></p>
      <p>This is a collection problem as much as a data problem. If your enrolment flow doesn&rsquo;t capture email at minimum, you&rsquo;re building a database you can&rsquo;t communicate with. Progressive data capture - gathering additional details across touchpoints - is the systematic fix.</p>
      ...
      <p>The connection between your POS and your CRM is often more fragile than it appears. <strong>Transactions may be delayed, partially mapped, or missing entirely for certain product categories or terminals.</strong> The result: member spend histories that look complete but have silent gaps - which in turn makes spend-based segmentation unreliable.</p>

      <h2>Gap 5: Preference and behavioural data that was never captured</h2>
      <p>Most venue CRMs store what members have done - visits, spend, redemptions. Very few capture why: preferred day-part, entertainment preferences, dietary restrictions, event attendance. This isn&rsquo;t a platform limitation in most cases. It&rsquo;s a capture strategy that was never built.</p>
      ...
      <p>ANALYTIQ was built in part to surface exactly these issues - without requiring manual database exports or analyst time. It identifies contactability gaps, flags anomalous transaction patterns that may indicate sync failures, and tracks data freshness across your member database. If you&rsquo;d like to see what it surfaces in your data, a free demo takes about 20 minutes.</p>
    </ArticleLayout>
  )
}
