...
export default function Article() {
  return (
    ...
    >
      ...
      <p>Discount-first loyalty programs attract discount-motivated members. That&rsquo;s not a customer base - it&rsquo;s a cost. When your best offer is &ldquo;10% off Tuesday lunch,&rdquo; you&rsquo;re training high-value customers to wait for deals rather than rewarding their natural behaviour.</p>
      <p>Relevance beats rewards. A personalised message referencing a customer&rsquo;s favourite night, their usual spend, or their anniversary of membership outperforms a generic offer by a significant margin - even when the offer itself is smaller.</p>
      ...
      <p>Strategy comes first. Platform selection - and configuration - follows. If your program can only do what the vendor pre-built, it&rsquo;s time to separate the strategy question from the technology question.</p>

      <h2>Mistake 5: Ignoring the 70% who joined and went quiet</h2>
      <p>Across most programs we audit, between 60&ndash;80% of the member database hasn&rsquo;t engaged with a campaign in the past six months. These aren&rsquo;t churned customers - many are still visiting. They&rsquo;re just not recognising that their visits connect to the program.</p>
      <p><strong>Passive members are the biggest untapped opportunity in most loyalty programs.</strong> A structured reactivation strategy - one built on behaviour triggers, not just &ldquo;we miss you&rdquo; emails - can move a meaningful percentage back into active status within 90 days.</p>
    </ArticleLayout>
  )
}
