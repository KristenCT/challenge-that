...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${base}/insights`,                              lastModified: new Date('2026-07-15'), priority: 0.7, changeFrequency: 'weekly'  },
    ...
    { url: `${base}/insights/loyalty-engagement-gap`,       lastModified: new Date('2026-07-15'), priority: 0.6, changeFrequency: 'monthly' },
