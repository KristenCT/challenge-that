        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="pt-1">
                <Link href="https://meetings-ap1.hubspot.com/kristen-makin/ct-introduction" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  Book a demo →
                </Link>
              </li>
            </ul>
