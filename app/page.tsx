      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Loyalty & CRM */}
            <ScrollReveal>
              <div className="rounded-2xl bg-ct-slate-subtle border border-ct-slate-subtle p-10 flex flex-col card-lift h-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <ScrollReveal delay={150}>
              <form action="mailto:info@challengethat.com.au" method="post" encType="text/plain" className="space-y-5">
                ...
                <p className="text-xs text-gray-400 text-center">Or <a href="https://meetings-ap1.hubspot.com/kristen-makin/ct-introduction" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">book a time directly</a> if you prefer.</p>
              </form>
            </ScrollReveal>
          </div>
        </div>
